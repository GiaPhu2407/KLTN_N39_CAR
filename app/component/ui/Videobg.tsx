...
const Videobg = () => {
  // Kích hoạt AOS khi component được mount
  useEffect(() => {
    AOS.init({
      duration: 1000, // Thời gian hiệu ứng
      easing: "ease-in-out", // Easing cho hiệu ứng
      once: false, // Làm cho hiệu ứng xuất hiện mỗi khi cuộn lên xuống
      offset: 100, // Khoảng cách hiệu ứng xuất hiện
    });
  }, []);
  ...
  return (
    <div className="w-full" data-theme="light">
      <div
        className="xl:mx-36 md:mx-26 mx-10 mb-14 text-center"
        data-aos="fade-up"
        data-aos-repeat="true"
      >
        <span className="font-semibold text-center xl:text-3xl md:text-2xl text-xl w-full font-serif">
          Explore the VinFast Family quality & comfort
        </span>
        <br />
        <span className="xl:text-xl md:text-lg sm:text-base text-xs">
          VinFast’s design language blends sporty curves, luxurious strokes, and
          formidable presence. It optimizes performance, functionality, and
          elegant simplicity, setting a new standard for electric car companies.
        </span>
      </div>

      <div
        className="xl:mx-36 md:mx-26 mx-10"
        data-aos="fade-up"
        data-aos-repeat="true"
      >
        <video
      ...
      <div>
        <section className="text-center py-12 px-4 bg-white">
          ...
          <p
            ...
            data-aos-repeat="true"
          >
            VinFast, the innovative new electric car company, prioritizes
            premium craftsmanship and high-quality parts in crafting its EVs.
            Engineered for safety, reliability, and comfort on every journey.
          </p>

          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {/* Warranty Section */}
            <div
              className="border-r md:border-r md:border-gray-300 p-4 flex flex-col items-center"
              data-aos="fade-left"
              data-aos-repeat="true"
            >
            ...
            >
              ...
              <h3 className="text-xl font-semibold mt-4">
                95% EV Charging Station Coverage
              </h3>
              <a href="#" className="text-blue-500 mt-2 hover:underline">
                Explore Charging →
              </a>
