              ...
              <div className="lg:w-1/2 p-4">
                <div className="logo mb-4">
                  ...
                  <div className="info text-black">
                    ...
                    <div>
                      <strong className="text-red-600">MST/MSDN:</strong>{" "}
                      0108926276 do Sở KHĐT TP Hà Nội cấp lần đầu ngày
                      01/10/2019 và các lần thay đổi tiếp theo.
                    </div>
                    <div>
                      <strong>Địa chỉ trụ sở chính:</strong> Số 7, đường Bằng
                      Lăng 1, Khu đô thị Vinhomes Riverside, Phường Việt Hưng,
                ...
                <div className="ecosystem text-black">
                  <p className="menu-title font-bold text-red-600">
                    Hệ sinh thái
                  </p>
                  <ul className="menu">
                    <li className="menu-item">
                      <a href="https://vinhomes.vn/vi" rel="nofollow">
                        Vinhomes
                      </a>
                    </li>
                    <li className="menu-item">
                ...
                <div className="menu-footer">
                  <div className="block-left">
                    <div className="menu-item">
                      <p className="menu-title text-black">
                        <a href="/ve-chung-toi">VỀ VINFAST</a>
                      </p>
                    </div>
                    <div className="menu-item">
                      <p className="menu-title text-black">
                        <a href="/ve-vingroup">VỀ VINGROUP</a>
                      </p>
                    </div>
                    <div className="menu-item">
                    ...
                    <div className="menu-item">
                      <p className="menu-title text-black">
                        <a href="/tim-kiem-showroom-tram-sac">
                          Showroom & Đại lý
                        </a>
                      </p>
                    </div>
              ...
              <div className="lg:w-1/4 p-4">
                <div className="cskh">
                  ...
                  <div className="connect-vf mt-4">
                    <div className="connect-title font-bold text-red-600">
                      Kết nối với VinFast
                    </div>
                    <div className="social flex space-x-4">
                      ...
                      >
                        ...
                        >
                          <path
                            d="M13.334 2.5H16.668C16.895 2.5 17.071 2.612 17.184 2.834C17.268 3.003 17.337 3.194 17.337 3.334V7.5H20V10H17.337V20H14.1667V10H12.5V7.5H14.1667V5.83333C14.1667 4.975 14.495 4.16667 15.5 4.16667H17.337V2.5H13.334Z"
                            fill="#8A8A8A"
                          ></path>
                        </svg>
                      </a>
                      <a
                        className="social-item"
                        href="https://www.youtube.com/channel/UCu1Je1p1lqxiyXBUi0vhRAg"
                        target="_blank"
                        title="Youtube"
                        rel="nofollow"
                      >
                        ...
                        >
                          <path
                            d="M20 10.0004C20 10.6429 19.974 11.2796 19.9034 11.8863C19.7483 13.8968 19.0243 15.7044 17.6378 17.0908C16.4203 18.3199 14.6378 19.1383 12.5005 19.1383C10.3657 19.1383 8.57727 18.3199 7.36783 17.0908C6.10339 15.7698 5.63959 14.0276 5.63959 10.0004C5.63959 5.9732 6.10339 4.23095 7.36783 2.90993C8.57727 1.68083 10.3657 0.8624 12.5005 0.8624C14.6378 0.8624 16.4203 1.68083 17.6378 2.90993C19.0243 4.29735 19.7483 6.10492 19.9034 8.11544C19.974 8.72223 20 9.35887 20 10.0004ZM8.86273 10.0004L12.5005 7.5004V12.5004L8.86273 10.0004Z"
                            fill="#8A8A8A"
                          ></path>
                        </svg>
                      </a>
                      <a
                        className="social-item"
                        href="https://www.instagram.com/vinfastauto/"
                        target="_blank"
                        title="Instagram"
                        rel="nofollow"
                      >
