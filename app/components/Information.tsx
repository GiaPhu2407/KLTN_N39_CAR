  ...
  return (
    ...
    <div className="xl:flex xl:flex-col py-7 ">
      <div className="relative xl:w-[600px] w-72 [animation-timeline:view()]  animation-range-entry animate-appear  group">
        ...
        <div className="absolute bottom-0 left-0 right-0  text-white text-left opacity-0 transform -translate-y-full group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
          <div className="p-4">
        ...
        <div className="absolute bottom-7 left-4  text-white text-left group-hover:transform group-hover:translate-y-[-100px] transition-all duration-500">
      ...
      <div className="relative xl:w-[600px] w-72 mt-7 animate-appearright [animation-timeline:view()]  animation-range-entry group">
        ...
        />
        {/* Phần hiện thêm khi hover */}
        <div className="absolute xl:ml-3 lg:ml-3 md:xl-3 sm:xl-3 ml-2 bottom-0 left-0 right-0  text-white text-left opacity-0 transform -translate-y-full group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
        ...
        {/* Khi hover, đẩy chữ "Pin & Trạm sạc ô tô điện" lên */}
        <div className="absolute bottom-4 left-4   text-white text-left group-hover:transform group-hover:translate-y-[-100px] transition-all duration-500">
