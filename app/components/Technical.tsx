...
const TechnicalSpecs = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 bg-blue-100 rounded-lg shadow-sm mb-20 ">
      ...
      <img src='https://shop.vinfastauto.com/on/demandware.static/-/Sites-app_vinfast_vn-Library/default/dw8a67356f/reserves/VF3/VF3_Rear 34_Driver_Side_Wheel_Cover1.png'></img>
    </div>
  );
};
